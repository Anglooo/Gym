...
[assembly: ExportRenderer(typeof(CustomMvxContentPage), typeof(CustomMvxContentPageRenderer))]
namespace GymApp.Forms.iOS.CustomRenderers
{
    public class CustomMvxContentPageRenderer : MvxPageRenderer
    {
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            if (((CustomMvxContentPage)Element).EnableBackButtonOverride)
            {
                SetCustomBackButton();
            }
        }
        ...
        private void SetCustomBackButton()
        {
            ...
            // Whatever your custom back button click handling
                if (((CustomMvxContentPage)Element)?.
        CustomBackButtonAction != null)
                {
                    ((CustomMvxContentPage)Element)?.
